...
def menupage():
    ...
    my_w = tk.Tk()
    # my_w.geometry("")
    width, height = my_w.winfo_screenwidth(), my_w.winfo_screenheight()

    my_w.geometry('%dx%d+0+0' % (width, height))
    ...
    img_top = tk.PhotoImage(file = "images.png")
    label = Label(frame_m_left, image = img_top)
    label.place(x=0,y=0)
    ...
    pdx, pdy = 40, 5
    # img_top = tk.PhotoImage(file = "images.png")
    # bg=tk.PhotoImage(file='images2.png')

    # img_l1 = tk.Label(frame_top,  image=img_top)
    # img_l1.grid(row=0,column=0,sticky='nw',pady=1)
    c1 = tk.Canvas(frame_m_left,width=1000,height=500,bg="#434242")
    c1.grid(row=0,column=0,columnspan=4,rowspan=4,sticky='nw',padx=0)
    # c1.create_image(0,0,image=bg,anchor='nw')


    img_menu1=tk.PhotoImage(file="food-item-1.png")
    img_menu2=tk.PhotoImage(file="food-item-2.png")
    img_menu3=tk.PhotoImage(file="food-item-3.png")
    img_menu4=tk.PhotoImage(file="food-item-4.png")
    img_menu5=tk.PhotoImage(file="food-item-5.png")


    menu1 = tk.Button(frame_m_left, image=img_menu1,height=150,width=150)
    menu1.grid(row=0, column=0, sticky='nw', padx=pdx, pady=pdy)
    menu2 = tk.Button(frame_m_left,  image=img_menu2,height=150,width=150)
    menu2.grid(row=0, column=1, sticky='nw', padx=pdx, pady=pdy)
    menu3 = tk.Button(frame_m_left,  image=img_menu3,height=150,width=150)
    menu3.grid(row=0, column=2, sticky='nw', padx=pdx, pady=pdy)
    menu4 = tk.Button(frame_m_left,  image=img_menu4,height=150,width=150)
    ...
    sb.append(sb4)
    menu5 = tk.Button(frame_m_left,  image=img_menu5,height=150,width=150)
    menu5.grid(row=2, column=0, sticky='nw', padx=pdx, pady=pdy)
    menu6 = tk.Button(frame_m_left,  image=img_menu1,height=150,width=150)
    menu6.grid(row=2, column=1, sticky='nw', padx=pdx, pady=pdy)
    menu7 = tk.Button(frame_m_left,  image=img_menu2,height=150,width=150)
    menu7.grid(row=2, column=2, sticky='nw', padx=pdx, pady=pdy)
    menu8 = tk.Button(frame_m_left,  image=img_menu3,height=150,width=150)
